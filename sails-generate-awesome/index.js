...
/**
* @kasundesilva/sails-generate-awesome
*
* Usage:
...
module.exports = {
  ...
  * @param  {Function} done
  */
//title:string,description:string,visibility:string,ordering:string
  before: function (scope, done) {

    var process = require('child_process');

    process.exec('sails generate model '+scope.args,function (err,stdout,stderr) {
      if (err) {
        console.log("\n"+stderr);
      } else {
        console.log(stdout);
    ...
    process.exec('sails generate page '+scope.args+'/'+scope.args,function (err,stdout,stderr) {
      if (err) {
        console.log("\n"+stderr);
      } else {
        console.log(stdout);
    ...
    process.exec('sails generate page '+scope.args+'/'+scope.args+'list',function (err,stdout,stderr) {
      if (err) {
        console.log("\n"+stderr);
      } else {
        console.log(stdout);
    ...
    process.exec('sails generate action '+scope.args+'/'+'remove'+scope.args,function (err,stdout,stderr) {
      if (err) {
        console.log("\n"+stderr);
      } else {
        console.log(stdout);
    ...
    process.exec('sails generate action '+scope.args+'/'+'save'+scope.args,function (err,stdout,stderr) {
      if (err) {
        console.log("\n"+stderr);
      } else {
        console.log(stdout);
    ...
    //   return done(new Error('Please provide a name for this awesome.'));
    // }
